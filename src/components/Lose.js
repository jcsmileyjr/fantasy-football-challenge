    ...
    return(
        <article className="h-screen flex flex-col ">
            ...
            {games.length === 1 && (games.home === team || games.visiting === team)
                ?<p className="mt-2 mx-4 text-center text-xl md:text-2xl lg:text-4xl">Team "{team}" lose the Championship.</p>
                :<p className="mt-2 mx-4 text-center text-xl md:text-2xl lg:text-4xl">Team "{team}" didn't make the play-offs.</p>
            }
