...
const Lose = ({team, restart, games}) => {
    return(
        <article className="h-screen flex flex-col ">
            ...
            <button type="button" className="mt-12 font-bold bg-blue-700 text-white rounded-2xl md:text-4xl mx-4 md:mx-20 md:py-2 lg:py-4" onClick={restart}>Play Again</button>
        </article>
    );
}
