...
const Lose = ({team, restart, games, generateStats}) => {
    ...
    return(
        <article className="h-screen flex flex-col ">
            <img src={Helmets} alt="blue and black clashing football helmets" className="lg:w-7/12 xl:w-6/12 2xl:w-6/12 lg:mx-auto" />
            ...
            <button type="button" className="lg:mt-16 mt-12 font-bold text-blue-900 bg-white rounded-2xl md:text-4xl mx-4 md:mx-20 lg:mx-40 xl:mx-60 md:py-2 lg:py-4" onClick={restart}>Play Again</button>
        </article>
    );
}
