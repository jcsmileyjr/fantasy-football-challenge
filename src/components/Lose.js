...
const Lose = ({team, restart, games}) => {
    return(
        <article className="h-screen flex flex-col ">
            ...
            <h1 className="mt-4 font-bold text-yellow-500 text-3xl md:text-6xl text-center">Game Over</h1>
            ...
            <button type="button" className="mt-12 font-bold bg-yellow-500 text-black rounded-2xl md:text-4xl mx-4 md:mx-20 lg:mx-40 xl:mx-60 md:py-2 lg:py-4" onClick={restart}>Play Again</button>
        </article>
    );
}
