    ...
    return (
        <article className="flex-col h-screen">
            <section className="flex-1 mx-2">
                <img className="w-full sm:mx-auto md:w-9/12" src={HelmetWithNames} alt="football helmets" />
            </section>
            <section className="flex-3 flex flex-col items-center">
                ...
                <input type="text" className="w-2/3  py-2 sm:py-4 sm:text-4xl text-center" onChange={(e) => createTeam(e.target.value)}></input>
            </section>
